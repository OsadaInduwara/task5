...
public class Covid4 {
  public static void main(String[] args) {
    ...
    System.out.println("countries with 11 deaths");
    table.stream().filter(covid -> covid.getDeaths() == 11)
        .forEach(System.out::println);

    System.out.println("countries with 0 deaths");
    table.stream().filter(covid -> covid.getDeaths() == 0)
        .forEach(System.out::println);
